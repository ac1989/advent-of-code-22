...
var isMarker = function (input, len) {
...
var p1 = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(), E.map(function (s) { return s.split(""); }),
                    E.map(function (xs) { return locateMarkerRec(xs, 0, 4); }),
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getInput()];
            case 1: return [2 /*return*/, _a.apply(void 0, [_b.sent(), E.map(function (s) { return s.split(""); }),
                    E.map(function (xs) { return locateMarkerRec(xs, 0, 14); }),
                    E.getOrElseW(function () { return "Failed to load file..."; })])];
        }
    });
}); };
